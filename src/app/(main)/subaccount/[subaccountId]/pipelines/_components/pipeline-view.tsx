...
import { LaneDetail, PipelineDetailsWithLanesCardsTagsTickets, TicketAndTags } from '@/lib/type'
...
const PipelineView = ({
       ...
       switch(type) {
            ...
            case "ticket": {
                ...
                if(source.droppableId === destination.droppableId) {
                    ...
                    setAllLanes(newLanes)
                    updateTicketsOrder([...destinationLane.Tickets,
                        ...originLane.Tickets,
                    ])
                    router.refresh()
                }
  ...
  return (
    <DragDropContext onDragEnd={onDragEnd}>
        <div
            className="bg-white/60 dark:bg-background/60 rounded-xl p-4 use-automation-zoom-in"
        >
            <div
