"use client"
import { AuthUserWithAgencySidebarOptionsSubAccounts, UserWithPermissionsAndSubAccounts } from '@/lib/type'
                    ...
                    render={({ field }) => (
                        <FormItem className='flex-1'>
                            ...
                            <Select
                                ...
                                onValueChange={(value) => {
                                    if(value === "SUACCOUNT_USER" || value === "SUBACCOUNT_GUEST"
                                    ) {
                                        setRoleState("You have to have subaccounts to assign Subaccount access to team members.")
                                    } else {
                                        setRoleState("")
                                    }
                    ...
                    <div>
                        ...
                        <div className='flex flex-col gap-4'>
                            {subAccounts?.map((subAccount) => {
                                const subAccountPermissionDetails = subAccountPermissions?.Permissions.find((permission) => permission.subAccountId === subAccount.id)
                               return (
                                <div key={subAccount.id} className='flex items-center justify-between rounded-lg border p-4'>
                                    <p>{subAccount.name}</p>
                                    <Switch disabled={loadingPermissions}   checked={subAccountPermissionDetails?.access}
