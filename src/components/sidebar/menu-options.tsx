...
import { ChevronsUpDown, Compass, Menu, PlusCircleIcon, Sidebar } from 'lucide-react'
  ...
  return (
    <Sheet 
        ...
        <SheetContent 
            showX={!defaultOpen}
            side={"left"}
            className={clsx("bg-background/80 backdrop-blur-xl fixed top-0 border-r-[1px] p-6", {"hidden md:inline-block z-0 w-[300px]": defaultOpen, "inline-block md:hidden z-[100] w-full": !defaultOpen, })}
        >
            <div>
                ...
                <Popover>
                    ...
                    <PopoverContent className='w-80 mt-4 h-80 z-[200]'>
                                ...
                                {sidebarOpt.map((sidebarOptions) => {
                                    ...
                                    return (
                                        <CommandItem key={sidebarOptions.id} className='md:w-[320px] w-full'>
                                            <Link href={sidebarOptions.link} className="flex items-center rounded-md transition-all md:w-full  w-[320px]">
                                                {val}
