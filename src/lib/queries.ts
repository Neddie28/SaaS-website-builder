...
import { v4 } from "uuid";
import { CreateFunnelFormSchema, CreateMediaType, UpsertFunnelPage } from "./type";
import { z } from "zod";
...
if(!agencyOwner) return console.log("❤️Error could not create subaccount")
...
export const getSubaccountDetails = async (subaccountId: string) => {
  ...
  export const getMedia = async (subacccountId: string) => {
  ...
  export const getLaneWithTicketAndTags = async (pipelineId: string) => {
...
// export const agencySubscription = async (agencyId: string) => {
